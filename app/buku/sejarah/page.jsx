...
export default function BookDetailPage() {
  const [book, setBook] = useState({
    id: 14, // Assigning an ID for this book
    title: "sejarah",
    author_name: "",
    publisher_name: "N/A",
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-400 p-6 text-white">
      ...
      <div className="max-w-4xl mx-auto bg-white text-black p-8 rounded-2xl shadow-2xl">
        ...
        <div className="mt-10">
          ...
          <div className="mb-6">
            <p className="font-semibold text-lg">Hilal</p>
            <p className="text-yellow-500 text-xl">★★★★★</p>
            <p className="mt-1 text-gray-700">
              sangat bagus untuk menambah wawasan tentang sejarah.
            </p>
            <hr className="mt-4" />
          </div>

          <div className="mb-6">
            <p className="font-semibold text-lg">maulana</p>
            <p className="text-yellow-500 text-xl">★★★★☆</p>
            <p className="mt-1 text-gray-700">
              Cerita-cerita sejarahnya sangat menarik dan informatif.
            </p>
            <hr className="mt-4" />
          </div>
        </div>
