...
export default function BookDetailPage() {
  const [book, setBook] = useState({
    id: 20, // Assigning an ID for this book
    title: "ilmu pengetahuan bumi dan antariksa",
    author_name: "wiji aziiz hari mukti",
    publisher_name: "N/A",
    available_quantity: 6,
    description: "ilmu pengetahuan bumi dan antariksa",
      ...
      <div className="max-w-4xl mx-auto bg-white text-black p-8 rounded-2xl shadow-2xl">
        ...
        <div className="mt-10">
          ...
          <div className="mb-6">
            ...
            <p className="text-yellow-500 text-xl">★★★★☆</p>
            <p className="mt-1 text-gray-700">
             buku bagus dan informatif tentang ilmu pengetahuan bumi dan antariksa.
            </p>
            <hr className="mt-4" />
          </div>
        </div>
