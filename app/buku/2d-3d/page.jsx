...
export default function BookDetailPage() {
  const [book, setBook] = useState({
    id: 13, // Assigning an ID for this book
    title: "ANIMASI 2D dan 3D",
    author_name: "Tim astra Animasi",
    publisher_name: "N/A",
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-400 p-6 text-white">
      ...
      <div className="max-w-4xl mx-auto bg-white text-black p-8 rounded-2xl shadow-2xl">
        ...
        <div className="mt-10">
          ...
          <div className="mb-6">
            <p className="font-semibold text-lg">arpen</p>
            <p className="text-yellow-500 text-xl">★★★★★</p>
            <p className="mt-1 text-gray-700">
              buku ini sangat informatif dan mudah dipahami oleh pemula.
            </p>
            <hr className="mt-4" />
          </div>

          <div className="mb-6">
            <p className="font-semibold text-lg">Nabila</p>
            <p className="text-yellow-500 text-xl">★★★★☆</p>
            <p className="mt-1 text-gray-700">
              buku ini memberikan wawasan baru tentang animasi 2D dan 3D yang
              sangat bermanfaat.
            </p>
            <hr className="mt-4" />
          </div>
