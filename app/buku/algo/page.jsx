...
export default function BookDetailPage() {
  const [book, setBook] = useState({
    id: 12, // Assigning an ID for this book
    title: "Algoritma dan Pemrograman",
    author_name: "Tim UMSUpress",
    publisher_name: "N/A",
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-400 p-6 text-white">
      ...
      <div className="max-w-4xl mx-auto bg-white text-black p-8 rounded-2xl shadow-2xl">
        ...
        <div className="mt-10">
          ...
          <div className="mb-6">
            <p className="font-semibold text-lg">reza</p>
            <p className="text-yellow-500 text-xl">★★★★★</p>
            <p className="mt-1 text-gray-700">
              buku bagus untuk pemula yang ingin belajar tentang algoritma dan
              pemrograman.
            </p>
            <hr className="mt-4" />
          </div>
          ...
          <div className="mb-6">
            <p className="font-semibold text-lg">ilham</p>
            <p className="text-yellow-500 text-xl">★★★★☆</p>
            <p className="mt-1 text-gray-700">
              sangat membantu dalam memahami konsep dasar algoritma dan pemrograman
            </p>
            <hr className="mt-4" />
          </div>
        </div>
