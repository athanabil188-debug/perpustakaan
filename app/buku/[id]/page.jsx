...
export default function BookDetailPage() {
  ...
  const handlePinjam = async () => {
    ...
    if (!book) {
      setBorrowingError('Detail buku tidak ditemukan');
      return;
    }
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-400 p-6 text-white flex items-center justify-center">
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-400 p-6 text-white flex items-center justify-center">
        <div className="max-w-4xl mx-auto bg-white text-black p-8 rounded-2xl shadow-2xl text-center">
          <h1 className="text-3xl font-bold mb-6">Detail Buku</h1>
          <div className="text-red-500 text-xl">Error: {error}</div>
          <a href="/library" className="inline-block mt-4 bg-blue-700 text-white py-3 px-6 rounded-xl font-semibold hover:bg-blue-800 transition">
  ...
  if (!book) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-400 p-6 text-white flex items-center justify-center">
        <div className="max-w-4xl mx-auto bg-white text-black p-8 rounded-2xl shadow-2xl text-center">
          <h1 className="text-3xl font-bold mb-6">Detail Buku</h1>
          <div className="text-red-500 text-xl">Book not found</div>
          <a href="/library" className="inline-block mt-4 bg-blue-700 text-white py-3 px-6 rounded-xl font-semibold hover:bg-blue-800 transition">
            Kembali ke Daftar Buku
          </a>
        </div>
