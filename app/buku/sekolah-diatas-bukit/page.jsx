...
export default function BookDetailPage() {
  const [book, setBook] = useState({
    id: 16, // Assigning an ID for this book
    title: "sekolah diatas bukit",
    author_name: "ahmad fuadi",
    publisher_name: "N/A",
    available_quantity: 10,
    description: "sekolah diatas bukit",
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-400 p-6 text-white">
      ...
      <div className="max-w-4xl mx-auto bg-white text-black p-8 rounded-2xl shadow-2xl">
        ...
        <div className="mt-10">
          ...
          <div className="mb-6">
            <p className="font-semibold text-lg">Lionel</p>
            <p className="text-yellow-500 text-xl">★★★★★</p>
            <p className="mt-1 text-gray-700">
            banyak pelajaran hidup yang bisa diambil dari buku ini.
            </p>
            <hr className="mt-4" />
          </div>
