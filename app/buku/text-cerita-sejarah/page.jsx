...
export default function BookDetailPage() {
  const [book, setBook] = useState({
    id: 9, // Assigning an ID for this book
    title: "text-cerita-sejarah",
    author_name: "Tri Wahyulita Nurhalimah",
    publisher_name: "N/A",
        ...
        <div className="mt-10">
          ...
          <div className="mb-6">
            ...
            <p className="mt-1 text-gray-700">
              Bukunya sangat menginspirasi dan bagus untuk dibaca.
            </p>
            <hr className="mt-4" />
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-yellow-500 text-xl">★★★★☆</p>
            <p className="mt-1 text-gray-700">
              sejarah itu penting untuk dipelajari agar kita tidak mengulangi
              kesalahan yang sama.
            </p>
            <hr className="mt-4" />
          </div>
